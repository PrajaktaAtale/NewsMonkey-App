...
const News = (props)=>{
    ...
    var apiKey= "d0c699b779ac4b3097a0da9ed8caae13"
    ...
    const fetchMoreData = async () => {  
        ...
        return (
            <>
                <h1 className="text-center" style={{ margin: '35px 0px',marginTop: '90px', color: 'darkgoldenrod' }}>NewsMonkey - Top {capitalizeFirstLetter(props.category)} Headlines</h1>
                {loading && <Spinner />}
                <InfiniteScroll
